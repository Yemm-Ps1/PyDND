...
class TestIsValidExpressionHandler(unittest.TestCase):
    ...
    def test_isValidExpression_d20_shouldReturnTrue(self):
        in_expression = "d20 "
        result = self.handler.is_valid_expression(in_expression)
    ...
    def test_isValidExpression_1d20minus3withAdvantage_shouldReturnTrue(self):
        ...
        result = self.handler.is_valid_expression(in_expression, roll_type=RollType.ADVANTAGE)
        self.assertTrue(result)
    ...
    def test_isValidExpression_1d12minus7WithSuperDisadvantage_shouldReturnFalse(self):
        in_expression = "1d12-7"
        result = self.handler.is_valid_expression(in_expression, roll_type=RollType.SUPER_DISADVANTAGE)
        self.assertFalse(result)
